---
id: comprehensive-thinking
name: 全面思考(五重审视复杂判断框架)
version: 1.0.0
platforms: [all]
tags: [全面思考, 深度理解, 系统性分析, 帮我想清楚, 从根上看, 根因分析, 架构判断, 策略判断, 复杂问题, 方法论, 系统方案, 复杂问题拆解, comprehensive-thinking, thinking, reasoning]
applies_when: "需求或判断具有高复杂度、高不确定性、高出错代价、长期影响或价值取舍:重大方案选型、架构判断、策略判断、根因分析、多模块/多环境/多数据源系统设计,或用户显式要求全面思考、深度理解、系统性分析、帮我想清楚、从根上看"
stage_hints: [classify, spec, architecture, review, acceptance]
see_also: [architecture-design, flutter-code-review, task-refinement]
---

# 全面思考

> 来源:[syzkillall/comprehensive-thinking-skill](https://github.com/syzkillall/comprehensive-thinking-skill)(Apache-2.0),由元臻设计;本文件按本项目 skill 加载器格式改编,并内联其《大师理论体系研究法》参考。
...
必须引入能够共同覆盖问题相关知识领域的大师成熟理论体系和经典著作,用这些理论体系的思考角度指导关键真实信息收集,再用理论体系蕴含的思维逻辑和收集到的关键信息进行系统化思考,关键公式是"思考 = 逻辑 × 信息",进而把握问题中的关键矛盾、矛盾主次,继而形成判断主轴。
...
这是全面思考的核心步骤。若这一步只是摘要前面材料,或者没有形成"当前问题自己的理论结构",整个全面思考就会流于形式。
...
高风险业务真值:支付、资金、账本、营收、客户资产、订单、第三方接口、线上可用性。
局部现象可能误导整体判断:接口 200 但数据不对、页面能打开但真值不对、超时但并非整体不可用。
重要方案选择或系统性收口:架构调整、状态机设计、阶段验收、上线前检查、复杂 bug 关闭。
Flutter 工程高责任判断:状态管理选型、跨端架构、数据持久化与同步方案、原生互操作边界、性能与体积取舍。
```
...
按本 skill 末尾附录《大师理论体系研究法》的模板提炼大师理论体系与大师思考角度。
