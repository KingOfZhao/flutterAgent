...
├── skills/                      # Markdown 形式的 skill / spec(61 个)
...
| `COLLAB_TOKEN_BUDGET` | 单次协作 token 软预算(0 关闭;超限提前收敛并标 `budget_exhausted`) | `0` |
...
| `devin-ai-engineer-mindset` | AI 工程师·Devin(自蒸馏):验证闭环 / 最小改动 / 先复现后修复 / 证据优先 / 显式升级 | docs.devin.ai + nuwa-skill |
